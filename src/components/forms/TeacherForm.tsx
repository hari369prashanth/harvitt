...
const TeacherForm = ({
  ...
  return (
    <div className="block inset-0 flex items-center justify-center bg-black  backdrop-blur-sm">
      <div className="relative w-full max-w-4xl h-auto overflow-hidden">
        <form
          className="flex flex-col gap-6 p-6 bg-white bg-opacity-90 backdrop-blur-lg shadow-xl rounded-lg text-black overflow-y-auto h-full"
          onSubmit={onSubmit}
        >
